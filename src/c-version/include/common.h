...
#error GNULinux build environments was not detected!
#endif
...
#define BENCHMARK_DURATION_MS 1000 /**< RECOMMENDED VALUE: At least 250. Number of milliseconds to run in each benchmark. */
